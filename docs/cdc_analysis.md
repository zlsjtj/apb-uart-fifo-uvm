...
- 三组基准 seed 的正式回归共 39/39 PASS，所有 warning、error、fatal 均为 0；
- 2026-09-03 的三组 seed 正式回归为 39/39 PASS，所有 warning、error、fatal 均为 0；
- 合并 39 个 UCDB 后，功能覆盖 65/65，断言 40/40，cover property 13/13，均为 100%；
