...
| Test | Seed | UCDB |
| --- | ---: | --- |
| uart_reg_test | 101 | `reports\uart_reg_test_101.ucdb` |
| uart_config_latency_test | 102 | `reports\uart_config_latency_test_102.ucdb` |
| uart_ral_test | 103 | `reports\uart_ral_test_103.ucdb` |
| uart_loopback_test | 104 | `reports\uart_loopback_test_104.ucdb` |
| uart_baud_loopback_test | 105 | `reports\uart_baud_loopback_test_105.ucdb` |
| uart_baud_timing_test | 106 | `reports\uart_baud_timing_test_106.ucdb` |
...
| uart_loopback_test | 204 | `reports\uart_loopback_test_204.ucdb` |
| uart_baud_loopback_test | 205 | `reports\uart_baud_loopback_test_205.ucdb` |
| uart_baud_timing_test | 206 | `reports\uart_baud_timing_test_206.ucdb` |
...
| uart_loopback_test | 304 | `reports\uart_loopback_test_304.ucdb` |
| uart_baud_loopback_test | 305 | `reports\uart_baud_loopback_test_305.ucdb` |
| uart_baud_timing_test | 306 | `reports\uart_baud_timing_test_306.ucdb` |
