...
- Simulator: `questa`
- Time: `2026-09-03 17:49:18`
- Clock config: `pclk_half=5ns pclk_phase=0ns uart_half=20ns uart_phase=0ns`

| Test | Seed | Status | Errors | Fatals | Warnings | Log |
| --- | ---: | --- | ---: | ---: | ---: | --- |
| uart_reg_test | 201 | PASS | 0 | 0 | 0 | `logs/uart_reg_test_201.log` |
| uart_config_latency_test | 202 | PASS | 0 | 0 | 0 | `logs/uart_config_latency_test_202.log` |
| uart_ral_test | 203 | PASS | 0 | 0 | 0 | `logs/uart_ral_test_203.log` |
| uart_loopback_test | 204 | PASS | 0 | 0 | 0 | `logs/uart_loopback_test_204.log` |
| uart_baud_loopback_test | 205 | PASS | 0 | 0 | 0 | `logs/uart_baud_loopback_test_205.log` |
| uart_baud_timing_test | 206 | PASS | 0 | 0 | 0 | `logs/uart_baud_timing_test_206.log` |
